...
const PERMISSIONS = [
  {
    ...
    description: 'Receive timely micro-action reminders, well-being nudges, and circle-of-life check-ins every 48 hours.',
  ...
  },
  {
    ...
    description: 'Read biometric baselines to personalise your well-being journey — heart rate, sleep quality, and more.',
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1.5">Grant access to unlock your full well-being potential</p>
      </div>
