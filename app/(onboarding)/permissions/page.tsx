...
const PERMISSIONS = [
  {
    id: 'notifications',
    icon: Bell,
    bgColor: 'bg-unicorn-50',
    iconColor: 'text-unicorn-600',
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex gap-2 mt-4">
                  <button
                    ...
                    className={`flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all ${
                      granted[id]
                        ...
                        : 'bg-unicorn-500 text-white hover:bg-unicorn-600'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl text-sm font-medium text-muted-foreground hover:bg-muted/70 transition-colors"
                  >
                    Skip
                  </button>
                </div>
