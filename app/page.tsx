    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 font-bold text-xl">
            <div className="w-8 h-8 rounded-lg bg-velvet-500 flex items-center justify-center shadow text-base">🦄</div>
            <span className="text-black font-black tracking-tight">Unicorn</span>
          </Link>

          <nav className="hidden md:flex items-center gap-2 text-sm font-medium">
            <a href="#features" className="px-4 py-2 text-black font-medium hover:text-velvet-500 transition-colors">Features</a>
            <a href="#how-it-works" className="px-4 py-2 text-black font-medium hover:text-velvet-500 transition-colors">How it works</a>
            <a href="#pricing" className="px-4 py-2 text-black font-medium hover:text-velvet-500 transition-colors">Pricing</a>
            <a href="#about" className="px-4 py-2 text-black font-medium hover:text-velvet-500 transition-colors">About us</a>
          </nav>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-100 px-6 py-4 flex flex-col gap-4 text-sm font-medium text-black">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-ochre-50 via-white to-sage-50 pt-24 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup" className="flex items-center gap-2 bg-velvet-500 text-white font-bold px-8 py-4 rounded-2xl shadow-xl hover:bg-velvet-600 transition-all text-lg">
              Start for free <ArrowRight className="h-5 w-5" />
            </Link>
            <a href="#how-it-works" className="flex items-center gap-2 text-black font-semibold px-8 py-4 rounded-2xl border border-gray-200 hover:border-ochre-300 hover:text-velvet-500 transition-all text-lg">
              See how it works
            </a>
          </div>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-3 max-w-2xl mx-auto">
            {CIRCLE.map(c => (
              <span key={c.label} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-gray-200 text-sm font-medium text-black shadow-sm hover:border-ochre-300 hover:shadow-md transition-all cursor-default">
      ...
      <section className="border-y border-gray-100 py-8 bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-wrap items-center justify-center gap-8 text-sm text-black">
          ...
          <span className="flex items-center gap-2">
            {/* 21-day: calendar with lightning */}
            <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
          ...
          <span className="flex items-center gap-2">
            {/* Privacy: shield with unicorn horn */}
            <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {STEPS.map(s => (
              <div key={s.num} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 relative">
                <div className="text-6xl font-black text-ochre-100 mb-4 leading-none">{s.num}</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <div className="text-gray-600 mb-6">21 days, no card needed</div>
              ...
              <Link href="/signup" className="block w-full text-center py-3 rounded-xl border-2 border-gray-200 font-semibold text-black hover:border-ochre-300 hover:bg-ochre-50 transition-all">
                Start free trial
              </Link>
            </div>
            ...
            <div className="bg-velvet-600 rounded-2xl p-8 text-white relative overflow-hidden">
              ...
              <div className="text-ochre-200 mb-6">per {plan === 'yearly' ? 'year' : 'month'} · cancel anytime</div>
              <ul className="space-y-3 mb-8">
      ...
      {/* ABOUT US */}
      <section id="about" className="py-24 bg-gradient-to-br from-velvet-50 to-ochre-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
              <div className="w-10 h-10 rounded-xl bg-velvet-100 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600 leading-relaxed">Unicorn is a holistic well-being platform that tracks all 8 dimensions of life — from physical health and career to creativity and spirituality. We combine biometric data, personalised micro-actions, and structured habit programs to help you grow every day.</p>
            </div>

            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
              <div className="w-10 h-10 rounded-xl bg-ochre-100 flex items-center justify-center mb-4">
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
              ...
              <p className="text-gray-600 leading-relaxed">To make holistic well-being accessible, measurable, and enjoyable for everyone. We believe small consistent actions — guided by data and personalised to you — create extraordinary life transformations over time.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">A world where every person has the tools and clarity to live a fully balanced life. We envision Unicorn as the global companion for personal growth — connecting body, mind, and purpose in one beautiful experience.</p>
            </div>
          </div>
        </div>
      </section>
